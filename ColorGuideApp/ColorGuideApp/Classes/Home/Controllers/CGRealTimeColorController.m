...
#import "CGRealTimeColorController.h"
#import <AVFoundation/AVFoundation.h>
#import "GPUImage.h"
#define DEVICE_IS_IPHONE5 ([[UIScreen mainScreen] bounds].size.height == 568)

@interface CGRealTimeColorController (){
    CALayer *trackingDot;
...
@property (weak, nonatomic) GPUImageView *VideoView;
...
@implementation CGRealTimeColorController
...
- (void)setupGPUImage
{
    ...
    __unsafe_unretained CGRealTimeColorController *weakSelf = self;
    
    videoRawData = [[GPUImageRawDataOutput alloc] initWithImageSize:videoPixelSize resultsInBGRAFormat:YES];
    __weak CGRealTimeColorController *safeSelf = self;
